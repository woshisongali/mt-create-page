...
class pageDetail extends pageParent {
    constructor(config) {
        super(config);
    }
    ...
    async toAst(modConfig) {
        ...
        const sourceFiles = pageDetail.CONFIG_PATH.sourFiles;
        const outPath = pageDetail.CONFIG_PATH.outPath;
        let filepaths = {
